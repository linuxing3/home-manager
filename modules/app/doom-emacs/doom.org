...
- [[#my-configdoomconfigel][My ~/.config/doom/config.el]]
...
- [[#my-configdoominitel][My ~/.config/doom/init.el]]
- [[#my-configdoompackagesel][My ~/.config/doom/packages.el]]
...
- [[./~/.config/doom/config.el][~/.config/doom/config.el]] - Stores your main configuration and allows to set user variables.
...
(if (file-exists-p "~/.config/doom/crdt-private.el") (load! "~/.config/doom/crdt-private.el"))
...
;; I login with a private elisp file: ~/.config/doom/freshrss-elfeed.el
...
(if (file-exists-p "~/.config/doom/freshrss-elfeed.el") (load! "~/.config/doom/freshrss-elfeed.el"))
...
You can also load separate files inside of [[./~/.config/doom/config.el][~/.config/doom/config.el]] via the =load!= function, like so:
...
#+BEGIN_SRC emacs-lisp :tangle ~/.config/doom/config.el
;;;------ helpful configuration ------;;;
(add-load-path! "~/.config/doom/package/mu4e")
(require 'mu4e)
...
(after! mu4e
  ...
  (if (file-exists-p "~/.config/doom/mu4e-private.el") (load! "~/.config/doom/mu4e-private.el"))
)
...
(package! devdocs)
#+END_SRC
* Nix slim Integration
In order to integrate my nix configuration, I use =doom-slim.nix= to generate =~/.config/doom=
[[file:doom-slim.nix][My doom configuration]]
