...
config.bind(",cc", "spawn --userscript org-store-link")
config.bind(";c", "hint links userscript org-store-link")
config.bind(",cw", "spawn --userscript org-capture-web")
config.bind(";w", "hint links userscript org-capture-web")

config.bind(",cq", "spawn --userscript qute-capture read -f ~/Org/inbox.org -H Web")
config.bind(",ck", "spawn --userscript qute-capture write -f ~/Org/inbox.org -H Web")
