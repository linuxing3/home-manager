...
in {
  ...
  home.sessionVariables = {
    ...
    NNN_TERMINAL = "${pkgs.st-xyz}/bin/st";
    NNN_TMPFILE = "~/.config/nnn/.lastd";
    NNN_PLUG = "p:preview-tabbed;c:-!printf '%s/%s' \\\"\\$PWD\\\" \\\"\\$nnn\\\" | ${pkgs.xclip}/bin/xclip -selection clipboard*;v:imgview;l:launch;z:fzcd;s:-!sudo ${pkgs.helix}/bin/hx \\\"\\$nnn\\\"*;r:gitroot;e:gpge;d:gpgd;S:gpgs;i:gpgv;g:-!git diff;";
  };
