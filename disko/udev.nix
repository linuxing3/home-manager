# Fork of nixpkgs nixos/modules/services/hardware/udev.nix from
# 26.11.20260816.e5bdc4a. systemd 261 chase()/openat2 returns EUNATCH on UOS 4.19.
{
  config,
  lib,
  pkgs,
...
let
  ...
  udevRulesFor =
    ...
    pkgs.runCommand name
      ...
      ''
        ...
        echo "Skipping udevadm verify (UOS kernel 4.19 EUNATCH)"
        echo "OK"
  ...
  hwdbBin = pkgs.writeText "hwdb.bin" "";
