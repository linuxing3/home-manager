...
(custom-set-faces!
  ...
  '(variable-pitch :family "Iosevka Nerd Font Mono")
...
(setq user-mail-address "linuxing3@qq.com")
...
(set-email-account! "qq"
                    '((mu4e-sent-folder       . "/qq/Sent Messages")
                      ...
                      (message-signature      . "---\nYours truly\nXing Wenju\nMinister\nChinese Embassy in Brazil")) t)

(set-email-account! "mfa"
                    '((mu4e-sent-folder       . "/mfa/Sent Messages")
                      (mu4e-drafts-folder     . "/mfa/Drafts")
                      (mu4e-trash-folder      . "/mfa/Trash")
                      (mu4e-refile-folder     . "/mfa/All Mail")
                      (message-signature      . "---\nYours truly\nXing Wenju\nMinister\nChinese Embassy in Brazil")) t)
